...
cp "./CHANGELOG.md" "icon.png" "./LICENSE.md" "$output_folder/$mod_name.deps.json" "$output_folder/$mod_name.dll" "$profiles_path/$secondary_profile/BepInEx/plugins/$mod_author-$mod_name"
